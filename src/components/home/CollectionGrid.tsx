    ...
    <section className="py-20 sm:py-28 px-4 sm:px-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 sm:mb-16 gap-4">
        ...
        <p className="text-sm text-neutral-500 max-w-md font-light">
          Engineered for distinctive presence. Explore the duality between solar protection and refined everyday optical vision.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        ...
        >
          ...
          <div className="relative z-10 text-white">
            ...
            <p className="text-xs sm:text-sm text-neutral-300 font-light max-w-sm mb-6 line-clamp-2">
              Deep tinted polarized UV400 lenses housed in handcrafted amber and obsidian translucent acetates.
            </p>
        ...
        >
          ...
          <div className="relative z-10 text-white">
            ...
            <p className="text-xs sm:text-sm text-neutral-300 font-light max-w-sm mb-6 line-clamp-2">
              Architectural square and round silhouettes engineered with anti-blue light coating and ultra-light titanium alloys.
            </p>
